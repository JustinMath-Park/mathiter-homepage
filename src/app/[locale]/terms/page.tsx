  ...
  ko: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `<p>Mathiter Tutoring의 교습료는 회사가 거주지 관할 교육지원청에 신고한 시간당 단가 × 월간 교습 시간으로 산정되며, 「학원의 설립·운영 및 과외교습에 관한 법률」 시간당 단가 상한(22,000원)을 준수합니다. 월간 교습 시간에는 다음이 모두 포함됩니다:</p><ul><li>1:1 실시간 화상 코칭 (동기 활동)</li><li>AI 학습 데이터 모니터링·진단 (비동기)</li><li>과제 첨삭 및 맞춤 커리큘럼 관리 (비동기)</li><li>학부모 주간 리포트 작성 (비동기)</li><li>Q&A 채널 응답 (비동기)</li></ul><p>현재 패키지 구성은 다음과 같습니다(2026-05-08 기준):</p><table style="width:100%;border-collapse:collapse;margin:12px 0;"><thead><tr style="background:#f5f5f5;"><th style="border:1px solid #ddd;padding:8px;text-align:left;">패키지</th><th style="border:1px solid #ddd;padding:8px;text-align:left;">학년</th><th style="border:1px solid #ddd;padding:8px;text-align:right;">월 교습료</th><th style="border:1px solid #ddd;padding:8px;text-align:left;">1:1 화상</th><th style="border:1px solid #ddd;padding:8px;text-align:right;">총 월 시간</th></tr></thead><tbody><tr><td style="border:1px solid #ddd;padding:8px;">Basic</td><td style="border:1px solid #ddd;padding:8px;">초등 (US G1~5)</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">600,000원</td><td style="border:1px solid #ddd;padding:8px;">주 2회 × 55분</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">30.1h</td></tr><tr><td style="border:1px solid #ddd;padding:8px;">Advanced</td><td style="border:1px solid #ddd;padding:8px;">중등 (US G6~8)</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">860,000원</td><td style="border:1px solid #ddd;padding:8px;">주 2회 × 55분</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">43.0h</td></tr><tr><td style="border:1px solid #ddd;padding:8px;">Pro</td><td style="border:1px solid #ddd;padding:8px;">고등 (US G9~11)</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">960,000원</td><td style="border:1px solid #ddd;padding:8px;">주 2회 × 55분</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">48.0h</td></tr><tr><td style="border:1px solid #ddd;padding:8px;">Master</td><td style="border:1px solid #ddd;padding:8px;">입시·경시</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">1,200,000원</td><td style="border:1px solid #ddd;padding:8px;">주 3회 × 55분</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">57.3h</td></tr></tbody></table><p>본 패키지 금액은 부가가치세법 시행령 제42조에 따라 부가가치세 면세 대상입니다. 회사가 교육지원청에 신고한 단가 및 시간 구성은 사이트 가격 페이지에서 항상 최신 상태로 게시되며, 회사는 단가 변경 시 기존 회원에게 영향을 미치지 않도록 다음 사이클부터 적용합니다.</p>`,
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `<p>Mathiter Tutoring tuition is calculated as the Company's declared hourly rate (filed with the regional Education Office) × monthly tutoring hours, complying with the statutory hourly cap of KRW 22,000 under Korean law. Monthly tutoring hours include the following components:</p><ul><li>1:1 real-time video coaching (synchronous)</li><li>AI learning data monitoring and diagnosis (asynchronous)</li><li>Homework review and personalized curriculum management (asynchronous)</li><li>Weekly parent reports (asynchronous)</li><li>Q&A channel responses (asynchronous)</li></ul><p>Current package structure (as of 2026-05-08):</p><table style="width:100%;border-collapse:collapse;margin:12px 0;"><thead><tr style="background:#f5f5f5;"><th style="border:1px solid #ddd;padding:8px;text-align:left;">Package</th><th style="border:1px solid #ddd;padding:8px;text-align:left;">Grade</th><th style="border:1px solid #ddd;padding:8px;text-align:right;">Monthly Tuition</th><th style="border:1px solid #ddd;padding:8px;text-align:left;">1:1 Video</th><th style="border:1px solid #ddd;padding:8px;text-align:right;">Total Monthly Hours</th></tr></thead><tbody><tr><td style="border:1px solid #ddd;padding:8px;">Basic</td><td style="border:1px solid #ddd;padding:8px;">Elementary (US G1~5)</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">KRW 600,000</td><td style="border:1px solid #ddd;padding:8px;">2/wk × 55min</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">30.1h</td></tr><tr><td style="border:1px solid #ddd;padding:8px;">Advanced</td><td style="border:1px solid #ddd;padding:8px;">Middle (US G6~8)</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">KRW 860,000</td><td style="border:1px solid #ddd;padding:8px;">2/wk × 55min</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">43.0h</td></tr><tr><td style="border:1px solid #ddd;padding:8px;">Pro</td><td style="border:1px solid #ddd;padding:8px;">High (US G9~11)</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">KRW 960,000</td><td style="border:1px solid #ddd;padding:8px;">2/wk × 55min</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">48.0h</td></tr><tr><td style="border:1px solid #ddd;padding:8px;">Master</td><td style="border:1px solid #ddd;padding:8px;">College Prep / Olympiad</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">KRW 1,200,000</td><td style="border:1px solid #ddd;padding:8px;">3/wk × 55min</td><td style="border:1px solid #ddd;padding:8px;text-align:right;">57.3h</td></tr></tbody></table><p>Package amounts are exempt from Korean VAT under Article 42 of the Enforcement Decree of the Value-Added Tax Act. Current declared rates and time compositions are always published on the pricing page in their latest form. Rate changes apply only from the next cycle for existing members.</p>`,
      },
      {
