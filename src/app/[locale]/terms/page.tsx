  ...
  ko: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `<p>Mathiter 학습앱은 다음 두 등급으로 제공됩니다:</p><ul><li><strong>무료 사용자</strong>: 기본 기능을 영구 무료로 이용할 수 있으나, 일일 사용량 제한이 적용됩니다(문제 풀이, AI 코칭, 강의 시청 등). 회원 가입 후 자동 적용되며 결제수단 등록을 요구하지 않습니다.</li><li><strong>유료 사용자</strong>: 모든 기능을 무제한 이용할 수 있으며, 월 34,900원(부가세 포함)의 결제가 적용됩니다.</li></ul><p><strong>현재 운영 중인 유료 상품 (2026-05-20 기준)</strong>: <strong>Mathiter Premium 1개월 이용권</strong> (단건 결제, 34,900원, 결제 즉시 30일간 이용 가능, 자동 갱신 없음). 정기구독(자동 갱신)은 추후 별도 출시 예정이며, 출시 시점에 회원에게 사전 공지합니다. 자세한 환불 조건은 <a href="/refund">환불정책</a> 페이지를 참고하세요.</p><p>회사는 무료/유료 기능 범위 및 일일 제한값을 서비스 운영상 필요에 따라 변경할 수 있으며, 중요 변경 사항은 사이트 공지 또는 이메일로 사전 안내합니다.</p>`,
      },
      {
        heading: "B-2. (추후 출시) 유료 정기구독 — 정기결제 및 자동 갱신",
        body: `<p style="background:#fff8e1;padding:10px 14px;border-left:3px solid #f59e0b;border-radius:4px;font-size:13px;"><strong>안내</strong>: 본 조항은 <strong>현재 출시되지 않은</strong> 정기구독 상품에 대한 미리 안내입니다. 현재 운영 중인 유료 상품은 단건 결제인 Mathiter Premium 1개월 이용권이며(B-1 참조), 아래 정기구독 조항은 출시 시점에 별도 공지 후 적용됩니다.</p><p>유료 구독은 회원이 등록한 결제수단(빌링키)에서 매월 자동 청구됩니다. 회원이 해지하기 전까지 자동 갱신되며, 갱신일은 첫 결제일과 동일한 일자입니다.</p><p>회원은 마이페이지에서 언제든 해지할 수 있으며, 해지 후에도 현재 결제 주기 종료 시점까지 유료 기능을 이용할 수 있습니다. 일할 환불은 제공되지 않습니다.</p><p>요금 변경 시 회사는 최소 30일 전 사전 공지하며, 회원은 변경된 요금에 동의하지 않는 경우 다음 갱신 전까지 해지할 수 있습니다.</p>`,
      },
      {
