...
> = {
  ko: {
    ...
    sections: [
      ...
      {
        heading: "B. Mathiter 학습앱 환불 정책",
        body: `<p>Mathiter 학습앱(SaaS)은 「전자상거래 등에서의 소비자보호에 관한 법률」 및 디지털 콘텐츠 약관 일반 원칙에 따라 다음과 같이 운영됩니다.</p>`,
      },
      {
        heading: "B-0. Mathiter Premium 1개월 이용권 (현재 운영 상품)",
        body: `<div style="background:#f0f7ff;padding:14px 18px;border-left:3px solid #2D6BFF;border-radius:6px;margin:10px 0;"><p style="margin:0 0 8px 0;"><strong>상품 정보</strong></p><ul style="margin:0;"><li><strong>상품명</strong>: Mathiter Premium 1개월 이용권</li><li><strong>가격</strong>: 34,900원 (부가가치세 포함)</li><li><strong>결제 방식</strong>: 단건 결제 (1회 청구)</li><li><strong>서비스 제공기간</strong>: 결제 즉시 ~ 30일 (1개월)</li><li><strong>서비스 제공 방식</strong>: 정보통신망을 통해 결제 즉시 디지털 콘텐츠 제공</li><li><strong>자동 갱신</strong>: 없음 (정기구독 출시 시 별도 안내)</li></ul></div><p><strong>환불 조건</strong>:</p><table style="width:100%;border-collapse:collapse;margin:10px 0;font-size:13px;"><thead><tr style="background:#f5f5f5;"><th style="border:1px solid #ddd;padding:8px;text-align:left;width:30%;">구분</th><th style="border:1px solid #ddd;padding:8px;text-align:left;">환불 처리</th></tr></thead><tbody><tr><td style="border:1px solid #ddd;padding:8px;"><strong>결제 후 7일 이내 + 유료 기능 미접속</strong></td><td style="border:1px solid #ddd;padding:8px;">전액 환불 (34,900원)</td></tr><tr><td style="border:1px solid #ddd;padding:8px;"><strong>회사 귀책사유 — 시스템 장애 24시간 이상</strong></td><td style="border:1px solid #ddd;padding:8px;">해당 일수 일할 환불 (34,900원 × 장애 일수 ÷ 30일)</td></tr><tr><td style="border:1px solid #ddd;padding:8px;"><strong>회사 귀책사유 — 표시·광고와 현저히 다른 경우</strong></td><td style="border:1px solid #ddd;padding:8px;">전액 환불 (34,900원)</td></tr><tr><td style="border:1px solid #ddd;padding:8px;"><strong>회사 사정으로 서비스 영구 중단</strong></td><td style="border:1px solid #ddd;padding:8px;">잔여 일수 비례 환불</td></tr><tr><td style="border:1px solid #ddd;padding:8px;"><strong>1회 이상 사용 후 단순 변심</strong></td><td style="border:1px solid #ddd;padding:8px;">환불 불가 (디지털 콘텐츠 즉시 제공 — 「전자상거래 등에서의 소비자보호에 관한 법률」 제17조 제2항 제5호)</td></tr><tr><td style="border:1px solid #ddd;padding:8px;"><strong>시스템 오류로 인한 중복 결제</strong></td><td style="border:1px solid #ddd;padding:8px;">자동 감지 후 영업일 7일 이내 전액 환불</td></tr></tbody></table><p style="font-size:13px;color:#555;"><strong>환불 처리 방식</strong>: 영업일 기준 7일 이내 원 결제수단(카드)으로 자동 환불됩니다. 환불 시 토스페이먼츠 자동 발행 현금영수증·세금계산서도 동시에 자동 취소됩니다. 등록된 결제수단이 만료된 경우 회원과 협의하여 계좌 환불로 대체합니다.</p>`,
      },
      {
        heading: "B-1. (추후 출시) 정기구독 해지 — 일할 환불 미제공",
        body: `<p style="background:#fff8e1;padding:10px 14px;border-left:3px solid #f59e0b;border-radius:4px;font-size:13px;"><strong>안내</strong>: 아래 정기구독(자동 갱신) 환불 정책은 <strong>현재 출시되지 않은</strong> 정기구독 상품에 대한 미리 안내입니다. 정기구독 출시 시점에 별도 공지 후 적용됩니다.</p><p>유료 구독자는 마이페이지에서 언제든 구독을 해지할 수 있습니다. 해지 시점에 다음 정책이 적용됩니다:</p><ul><li><strong>해지 후 즉시 자동 갱신 중단</strong>: 다음 결제 주기에는 자동 청구되지 않습니다.</li><li><strong>현재 결제 주기 종료 시까지 이용 가능</strong>: 이미 결제된 1개월 기간 동안 유료 기능을 그대로 이용할 수 있습니다.</li><li><strong>일할 환불 미제공</strong>: 결제 주기 중간에 해지하더라도 잔여 기간에 대한 일할 환불은 제공되지 않습니다.</li></ul>`,
      },
      {
      ...
      },
      {
        ...
        body: `<p>환불을 요청하시려면 다음 중 하나의 방법으로 연락해 주시기 바랍니다:</p><ul><li><strong>이메일</strong>: <a href="mailto:support@mathiter.com">support@mathiter.com</a> — 회원 가입 이메일·결제 일시·환불 사유 명시.</li><li><strong>카카오톡 채널</strong>: <a href="https://pf.kakao.com/_sUxnxkn/chat" target="_blank" rel="noopener noreferrer">@mathiter</a> — 클릭하면 1:1 채팅이 바로 열립니다.</li><li><strong>마이페이지</strong>: "결제 내역 → 환불 요청" 메뉴 (개발 예정).</li></ul>`,
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      {
        heading: "B. Mathiter learning app Refund Policy",
        body: `<p>The Mathiter learning app (SaaS) follows the principles of Korea's Act on Consumer Protection in Electronic Commerce and standard digital content terms.</p>`,
      },
      {
        heading: "B-0. Mathiter Premium 1-Month Pass (Currently Active Product)",
        body: `<div style="background:#f0f7ff;padding:14px 18px;border-left:3px solid #2D6BFF;border-radius:6px;margin:10px 0;"><p style="margin:0 0 8px 0;"><strong>Product Details</strong></p><ul style="margin:0;"><li><strong>Product</strong>: Mathiter Premium 1-Month Pass</li><li><strong>Price</strong>: KRW 34,900 (VAT included)</li><li><strong>Payment type</strong>: One-time charge</li><li><strong>Service period</strong>: From payment time + 30 days (1 month)</li><li><strong>Delivery</strong>: Digital content provided immediately via the internet upon payment</li><li><strong>Auto-renewal</strong>: None (recurring subscription to be announced separately)</li></ul></div><p><strong>Refund Conditions</strong>:</p><table style="width:100%;border-collapse:collapse;margin:10px 0;font-size:13px;"><thead><tr style="background:#f5f5f5;"><th style="border:1px solid #ddd;padding:8px;text-align:left;width:30%;">Case</th><th style="border:1px solid #ddd;padding:8px;text-align:left;">Refund</th></tr></thead><tbody><tr><td style="border:1px solid #ddd;padding:8px;"><strong>Within 7 days of payment + never accessed paid features</strong></td><td style="border:1px solid #ddd;padding:8px;">Full refund (KRW 34,900)</td></tr><tr><td style="border:1px solid #ddd;padding:8px;"><strong>Company's fault — system outage 24+ hours</strong></td><td style="border:1px solid #ddd;padding:8px;">Pro-rated refund for outage days (KRW 34,900 × days ÷ 30)</td></tr><tr><td style="border:1px solid #ddd;padding:8px;"><strong>Company's fault — service materially differs from advertised</strong></td><td style="border:1px solid #ddd;padding:8px;">Full refund (KRW 34,900)</td></tr><tr><td style="border:1px solid #ddd;padding:8px;"><strong>Company permanently discontinues service</strong></td><td style="border:1px solid #ddd;padding:8px;">Pro-rated refund for remaining days</td></tr><tr><td style="border:1px solid #ddd;padding:8px;"><strong>Buyer's remorse after 1+ use of paid features</strong></td><td style="border:1px solid #ddd;padding:8px;">No refund (Korean Consumer Protection Act Art. 17(2)(5) — digital content immediately consumable)</td></tr><tr><td style="border:1px solid #ddd;padding:8px;"><strong>System error duplicate charge</strong></td><td style="border:1px solid #ddd;padding:8px;">Auto-detected and refunded within 7 business days</td></tr></tbody></table><p style="font-size:13px;color:#555;"><strong>Refund processing</strong>: Refunds are processed within 7 business days back to the original payment method (card). Cash receipts and tax invoices issued automatically by Toss Payments are also cancelled automatically. If the payment method has expired, an alternative refund (bank transfer) will be arranged with the customer.</p>`,
      },
      {
        heading: "B-1. (Future) Recurring Subscription Cancellation — No Pro-Rated Refund",
        body: `<p style="background:#fff8e1;padding:10px 14px;border-left:3px solid #f59e0b;border-radius:4px;font-size:13px;"><strong>Notice</strong>: The recurring subscription (auto-renewal) refund policy below applies to a product that <strong>has not been released yet</strong>. It will take effect when the recurring subscription product is launched, with a separate announcement.</p><p>Paid subscribers may cancel anytime via My Page. The following applies at cancellation:</p><ul><li><strong>Auto-renewal stops immediately</strong>: No further automatic charges occur in subsequent billing periods.</li><li><strong>Access continues until end of current period</strong>: Paid features remain accessible through the end of the already-paid month.</li><li><strong>No pro-rated refunds</strong>: Mid-period cancellations do not trigger a refund for unused days.</li></ul>`,
      },
      {
      ...
      },
      {
        ...
        body: `<p>To request a refund, contact us through one of the following:</p><ul><li><strong>Email</strong>: <a href="mailto:support@mathiter.com">support@mathiter.com</a> — Include registered email, payment date/time, and refund reason.</li><li><strong>KakaoTalk Channel</strong>: <a href="https://pf.kakao.com/_sUxnxkn/chat" target="_blank" rel="noopener noreferrer">@mathiter</a> — Click to open a 1:1 chat instantly.</li><li><strong>My Page</strong>: "Payment history → Request refund" menu (planned).</li></ul>`,
      },
      {
