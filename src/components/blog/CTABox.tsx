...
const COPY = {
  ko: {
    default: {
      ...
      body: "Mathiter Tutoring에서 30분 무료 상담을 진행합니다. 8년간 SAT 만점·AP Calc BC 5점 학생을 다수 배출한 Mathiter Tutoring이 직접 상담해 드립니다.",
      note: "영업시간 1시간 이내 회신 · 1회 시범 수업 후 결정",
      cta: "무료 30분 상담 신청",
    },
    persona1: {
      title: "국제학교 진학을 앞두고 계신가요?",
      body: "입학 전에 영어 수학 환경에 적응시켜주는 것이 가장 효과적입니다. 두 자녀를 해외 국제학교에서 직접 키운 같은 학부모로서 Mathiter Tutoring이 직접 상담드립니다.",
      note: "영업시간 1시간 이내 회신 · 1회 시범 수업 후 결정",
      cta: "무료 30분 상담 신청",
    },
    persona3: {
