...
export default async function TutoringStructuredData() {
  ...
  const organizationSchema = {
    ...
    offers: [
      {
        "@type": "Offer",
        name: t("pricing.elem.name"),
        description: t("pricing.elem.desc"),
        price: t("pricing.elem.price"),
        priceCurrency: t("pricing.currencyCode"),
      },
      {
        "@type": "Offer",
        name: t("pricing.middle.name"),
        description: t("pricing.middle.desc"),
        price: t("pricing.middle.price"),
        priceCurrency: t("pricing.currencyCode"),
      },
      {
        "@type": "Offer",
        name: t("pricing.high.name"),
        description: t("pricing.high.desc"),
        price: t("pricing.high.price"),
        priceCurrency: t("pricing.currencyCode"),
      },
    ],
  };
