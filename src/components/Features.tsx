...
const featureKeys = ["coach", "analytics", "gamification", "examPractice", "dashboard"] as const;
...
const demoReady = new Set(["coach", "analytics", "gamification", "examPractice", "dashboard"]);
